        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
                    ...
                    <div id="search-map" class="w-full h-72 rounded-lg"></div>
                </div>
...
<!-- Leaflet map integration for search results -->
<link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" integrity="sha256-o9N1j7kPcIwfLkaphyx4n1ZJ8a9Z4zC1X6P4dF9k1hA=" crossorigin=""/>
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js" integrity="sha256-o9N1j7kPcIwfLkaphyx4n1ZJ8a9Z4zC1X6P4dF9k1hA=" crossorigin=""></script>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const mapContainer = document.getElementById('search-map');
        if (!mapContainer) return;

        const map = L.map('search-map').setView([13.443182, -15.310139], 10);
        ...
        const properties = @json(collect($properties->items())->filter(function ($property) {
        ...
        properties.forEach((prop) => {
            ...
            const popupContent = `<div class="text-sm"><strong>${prop.title}</strong><br/>` +
                `GMD ${prop.price}<br/><a href="${prop.url}" class="text-blue-600 underline">View details</a></div>`;
